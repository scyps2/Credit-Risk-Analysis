...
# MLP Classifying
X_train = df_train[['y_0', 'y_1', 'y_2', 'y_3', 'grade_0', 'grade_1', 'mev_-1', 'mev_1']].dropna().to_numpy()
y_train = df_train[['y_next_0', 'y_next_1', 'y_next_2', 'y_next_3']].dropna().to_numpy()
X_test = df_test[['y_0', 'y_1', 'y_2', 'y_3', 'grade_0', 'grade_1', 'mev_-1', 'mev_1']].dropna().to_numpy()
